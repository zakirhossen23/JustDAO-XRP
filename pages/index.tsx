...
export default function Welcome() {
  ...
  return (
    <>
      <Head>
        <title>JustDAO</title>
        <meta name="description" content="JustDAO" />
      ...
      <div className={styles.section}>
        <div className={styles.text}>
          ...
          <p className="py-4"> 
JustDAO is an innovative Software-as-a-Service (SaaS) platform designed to empower communities with trust through the utilization of a decentralized autonomous organization (DAO) framework. JustDAO is built on the XRP infrastructure with the principles of transparency, collaboration, and fairness. JustDAO enables communities to govern themselves, make decisions collectively, have a transparency payments process and build trust-based ecosystems. Everything in just a couple clicks. Start your DAO today and give everyone in your community a voice.
